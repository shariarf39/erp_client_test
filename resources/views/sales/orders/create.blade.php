            ...
            <div class="col-md-8">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-success text-white py-3">
                        <h5 class="mb-0"><i class="fas fa-file-invoice-dollar"></i> SO Header Information</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="so_no" class="form-label">SO Number <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('so_no') is-invalid @enderror" 
                                    id="so_no" name="so_no" value="{{ old('so_no', $soNumber) }}" readonly>
                                @error('so_no')
            ...
            <div class="col-md-4">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <a href="{{ route('sales.orders.index') }}" class="btn btn-secondary w-100">
