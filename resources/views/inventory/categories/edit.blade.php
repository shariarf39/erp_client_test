...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('inventory.categories.show', $category) }}" class="btn btn-info">
    ...
    <div class="row g-4">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('inventory.categories.update', $category) }}" method="POST">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('inventory.categories.show', $category) }}" class="btn btn-secondary">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="h6">{{ $category->category_code }}</div>
                    </div>
                    <div class="mb-3">
                        <div class="text-muted small">Category Name</div>
                        <div class="h6">{{ $category->category_name }}</div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="h5 text-primary">{{ $category->items->count() }}</div>
                    </div>
                    <div class="mb-3">
                        <div class="text-muted small">Sub-Categories</div>
                        <div class="h5 text-info">{{ $category->children->count() }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <ul class="mb-0 ps-3">
                        <li class="mb-2"><strong>Category Code:</strong> Must be unique across all categories</li>
                        <li class="mb-2"><strong>Parent Category:</strong> Cannot select itself as parent</li>
                        <li class="mb-2"><strong>Inactive Status:</strong> Will hide category from dropdowns</li>
                        <li><strong>Cannot Delete:</strong> If category has items or sub-categories</li>
                    </ul>
                </div>
            </div>
        </div>
