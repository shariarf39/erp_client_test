...
@section('title', 'Edit Training Program - SENA.ERP')

@section('content')
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-0"><i class="fas fa-graduation-cap me-2"></i>Edit Training Program</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('hr.training.programs.index') }}">Training Programs</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('hr.training.programs.show', $program->id) }}">{{ $program->program_code }}</a></li>
        ...
        <div class="col-lg-9">
            <form action="{{ route('hr.training.programs.update', $program->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" 
                                    ...
                                    <option value="Technical" {{ old('category', $program->category) == 'Technical' ? 'selected' : '' }}>Technical</option>
                                    <option value="Soft Skills" {{ old('category', $program->category) == 'Soft Skills' ? 'selected' : '' }}>Soft Skills</option>
                                    <option value="Leadership" {{ old('category', $program->category) == 'Leadership' ? 'selected' : '' }}>Leadership</option>
                                    <option value="Compliance" {{ old('category', $program->category) == 'Compliance' ? 'selected' : '' }}>Compliance</option>
                                    <option value="Safety" {{ old('category', $program->category) == 'Safety' ? 'selected' : '' }}>Safety</option>
                                    <option value="Product" {{ old('category', $program->category) == 'Product' ? 'selected' : '' }}>Product</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('training_type') is-invalid @enderror" 
                                    ...
                                    <option value="Classroom" {{ old('training_type', $program->training_type) == 'Classroom' ? 'selected' : '' }}>Classroom</option>
                                    <option value="Online" {{ old('training_type', $program->training_type) == 'Online' ? 'selected' : '' }}>Online</option>
                                    <option value="On-the-Job" {{ old('training_type', $program->training_type) == 'On-the-Job' ? 'selected' : '' }}>On-the-Job</option>
                                    <option value="Workshop" {{ old('training_type', $program->training_type) == 'Workshop' ? 'selected' : '' }}>Workshop</option>
                                    <option value="Seminar" {{ old('training_type', $program->training_type) == 'Seminar' ? 'selected' : '' }}>Seminar</option>
                                    <option value="Conference" {{ old('training_type', $program->training_type) == 'Conference' ? 'selected' : '' }}>Conference</option>
                                    <option value="Certification" {{ old('training_type', $program->training_type) == 'Certification' ? 'selected' : '' }}>Certification</option>
                                </select>
                                @error('training_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control @error('trainer_name') is-invalid @enderror" 
                                       id="trainer_name" name="trainer_name" value="{{ old('trainer_name', $program->trainer_name) }}">
                                @error('trainer_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('trainer_type') is-invalid @enderror" 
                                    ...
                                    <option value="">Select Type</option>
                                    <option value="Internal" {{ old('trainer_type', $program->trainer_type) == 'Internal' ? 'selected' : '' }}>Internal</option>
                                    <option value="External" {{ old('trainer_type', $program->trainer_type) == 'External' ? 'selected' : '' }}>External</option>
                                    <option value="Online Platform" {{ old('trainer_type', $program->trainer_type) == 'Online Platform' ? 'selected' : '' }}>Online Platform</option>
                                </select>
                                @error('trainer_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.5" min="0" class="form-control @error('duration_days') is-invalid @enderror" 
                                       id="duration_days" name="duration_days" value="{{ old('duration_days', $program->duration_days) }}">
                                @error('duration_days')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.5" min="0" class="form-control @error('duration_hours') is-invalid @enderror" 
                                       id="duration_hours" name="duration_hours" value="{{ old('duration_hours', $program->duration_hours) }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control @error('cost_per_participant') is-invalid @enderror" 
                                       id="cost_per_participant" name="cost_per_participant" value="{{ old('cost_per_participant', $program->cost_per_participant) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control @error('start_date') is-invalid @enderror" 
                                       id="start_date" name="start_date" value="{{ old('start_date', $program->start_date) }}">
                                @error('start_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control @error('enrollment_deadline') is-invalid @enderror" 
                                       id="enrollment_deadline" name="enrollment_deadline" value="{{ old('enrollment_deadline', $program->enrollment_deadline) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('prerequisites') is-invalid @enderror" 
                                      id="prerequisites" name="prerequisites" rows="2">{{ old('prerequisites', $program->prerequisites) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('objectives') is-invalid @enderror" 
                                      id="objectives" name="objectives" rows="3">{{ old('objectives', $program->objectives) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" 
                                ...
                                <option value="Open for Enrollment" {{ old('status', $program->status) == 'Open for Enrollment' ? 'selected' : '' }}>Open for Enrollment</option>
                                <option value="In Progress" {{ old('status', $program->status) == 'In Progress' ? 'selected' : '' }}>In Progress</option>
                ...
                <div class="d-flex gap-2 mb-4">
                    ...
                    <a href="{{ route('hr.training.programs.show', $program->id) }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    <ul class="list-unstyled small mb-0">
                        <li class="mb-2">
                            ...
                            Update status as program progresses
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check-circle text-success me-2"></i>
                        ...
                        <li class="mb-2">
                            <i class="fas fa-check-circle text-success me-2"></i>
                            Keep dates and venue current
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-exclamation-triangle text-warning me-2"></i>
                            Cannot change code if enrolled
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    <p class="mb-2">
                        ...
                        <span class="fs-4">{{ $program->enrollments->count() }}</span>
                    ...
                    <div class="alert alert-warning small mb-0 mt-3">
                        ...
                        Program has enrolled participants. Changes may affect them.
                    </div>
                    @endif
                </div>
            </div>
