...
@section('title', 'Create Performance Review - SENA.ERP')

@section('content')
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-0"><i class="fas fa-star me-2"></i>Create Performance Review</h2>
        ...
        <div class="col-lg-9">
            <form action="{{ route('hr.performance.reviews.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('review_type') is-invalid @enderror" 
                                    ...
                                    <option value="Mid-Year" {{ old('review_type') == 'Mid-Year' ? 'selected' : '' }}>Mid-Year</option>
                                    <option value="Quarterly" {{ old('review_type') == 'Quarterly' ? 'selected' : '' }}>Quarterly</option>
                                    <option value="Project-Based" {{ old('review_type') == 'Project-Based' ? 'selected' : '' }}>Project-Based</option>
                                </select>
                                @error('review_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('achievements') is-invalid @enderror" 
                                      id="achievements" name="achievements" rows="4">{{ old('achievements') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('strengths') is-invalid @enderror" 
                                      id="strengths" name="strengths" rows="4">{{ old('strengths') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('areas_for_improvement') is-invalid @enderror" 
                                      id="areas_for_improvement" name="areas_for_improvement" rows="4">{{ old('areas_for_improvement') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('goals_for_next_period') is-invalid @enderror" 
                                      id="goals_for_next_period" name="goals_for_next_period" rows="4">{{ old('goals_for_next_period') }}</textarea>
                ...
                <div class="d-flex gap-2 mb-4">
                    ...
                    <a href="{{ route('hr.performance.reviews.index') }}" class="btn btn-secondary">
        ...
        <div class="col-lg-3">
            <div class="card shadow-sm mb-3">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="fas fa-info-circle me-2"></i>Review Guidelines</h6>
                </div>
                <div class="card-body">
