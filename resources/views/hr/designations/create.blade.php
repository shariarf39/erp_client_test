...
@section('title', 'Create Designation - SENA.ERP')

@section('content')
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-0"><i class="fas fa-id-badge me-2"></i>Create New Designation</h2>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <p class="small mb-2"><strong>Designation Code:</strong> Unique identifier for the position</p>
                    <p class="small mb-2"><strong>Title:</strong> The name of the position</p>
                    <p class="small mb-2"><strong>Level:</strong> Organizational hierarchy (optional)</p>
                    <p class="small mb-0"><strong>Status:</strong> Enable/disable this designation</p>
                </div>
            </div>
        </div>
    </div>
