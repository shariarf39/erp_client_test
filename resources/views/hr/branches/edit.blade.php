...
@section('title', 'Edit Branch - SENA.ERP')

@section('content')
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-0"><i class="fas fa-code-branch me-2"></i>Edit Branch</h2>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('hr.branches.update', $branch->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('manager_id') is-invalid @enderror" 
                                    ...
                                    @foreach($employees as $employee)
                                        <option value="{{ $employee->id }}" {{ old('manager_id', $branch->manager_id) == $employee->id ? 'selected' : '' }}>
