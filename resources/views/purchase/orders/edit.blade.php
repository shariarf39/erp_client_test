        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Edit: {{ $order->po_no }}</li>
                </ol>
            </nav>
        </div>
        <div>
            <a href="{{ route('purchase.orders.show', $order) }}" class="btn btn-info">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('pr_id') is-invalid @enderror" 
                                    ...
                                    @foreach($requisitions as $pr)
                                        <option value="{{ $pr->id }}" 
                                                {{ old('pr_id', $order->pr_id) == $pr->id ? 'selected' : '' }}>
                                            {{ $pr->pr_number }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('payment_terms') is-invalid @enderror" 
                                          ...
                                          name="payment_terms" 
                                          rows="2"
                                          placeholder="e.g., Net 30 days, 50% advance">{{ old('payment_terms', $order->payment_terms) }}</textarea>
                                @error('payment_terms')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
